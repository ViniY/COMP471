...
if __name__ == '__main__':
    ...
    plot_clusters(out_stem + '_K2means.png', data, cluster.KMeans, (), {'n_clusters': 2})
    plot_clusters(out_stem + '_K4means.png', data, cluster.KMeans, (), {'n_clusters': 4})
    plot_clusters(out_stem + '_K6means.png', data, cluster.KMeans, (), {'n_clusters': 6})
    plot_clusters(out_stem + '_K8means.png', data, cluster.KMeans, (), {'n_clusters': 8})
    ...
    plot_clusters(out_stem + '_AffinityProp.png', data, cluster.AffinityPropagation, (),
